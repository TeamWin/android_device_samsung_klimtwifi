DEVICE_TREE := device/samsung/klimtwifi
...
TARGET_KERNEL_DEVICE_DEFCONFIG := device_klimtwifi_usa
...
TARGET_INIT_VENDOR_LIB := libinit_klimtwifi
TARGET_RECOVERY_DEVICE_MODULES := libinit_klimtwifi
TARGET_LIBINIT_DEFINES_FILE := $(DEVICE_TREE)/init/init_klimtwifi.cpp
